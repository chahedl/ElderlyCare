...
class DistanceService {
  ...
  Future<Map<String, dynamic>> fetchDistances(
    ...
    for (var mode in modes.keys) {
      ...
      final url = '$baseUrl/$profile?api_key=$apiKey&start=$originLon,$originLat&end=$destLon,$destLat';
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          if (data['features'] != null && data['features'].isNotEmpty) {
            ...
            final distance = feature['properties']['segments'][0]['distance'] / 1000; // Convert meters to km
            final duration = feature['properties']['segments'][0]['duration'] / 60; // Convert seconds to minutes
            distances[mode] = {
