...
class _PharmacyScreenState extends State<PharmacyScreen> {
  ...
  static const double _geofenceRadius = 1500.0; // Increased to 1500 meters
  Map<String, dynamic>? _weatherData;
  String? _weatherError;
  bool _usingMockData = false;
  Map<String, dynamic>? _distances;
  String? _distanceError;
  bool _isDetailsVisible = true; // Track visibility of details UI
  ...
  Future<void> _getUserLocation() async {
    try {
      ...
      if (_viewModel.pharmacies.isNotEmpty && _viewModel.pharmacies.any((p) => p.name.contains("Mock"))) {
        setState(() {
          _usingMockData = true;
        });
      }
  ...
  void _showGeofenceAlert() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('You have left the safe area! Please return to your starting location.'),
        actions: [
          TextButton(
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: _distanceError != null
                        ? Text(_distanceError!, style: const TextStyle(color: Colors.red))
                        : _distances != null
                            ? Column(
                                ...
                                children: [
                                  ...
                                  _buildDistanceRow('Walking', _distances!['walking']),
                                  _buildDistanceRow('Driving (Car)', _distances!['driving']),
                                  _buildDistanceRow('Cycling (Motorcycle)', _distances!['cycling']),
                                  const SizedBox(height: 8),
                                  // Drugs Information
                                  Text(
                                    'Available Drugs',
                                  ...
                                  ..._selectedPharmacy!.drugs.map((drug) => Padding(
                  ...
                  children: [
                            ...
                            options: MapOptions(
                              ...
                              onTap: (tapPosition, point) {
                                setState(() {
                                  ...
                                  _distances = null;
                                  _distanceError = null;
                                  _isDetailsVisible = true; // Show details when map is tapped
                                });
                              },
                            ),
                            children: [
                    ...
                    Positioned(
                      ...
                      child: FloatingActionButton(
                        ...
                        child: Icon(
                          _isDetailsVisible ? Icons.arrow_downward : Icons.arrow_upward,
                          size: 20,
                        ),
                      ),
                    ),
